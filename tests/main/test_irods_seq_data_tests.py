...
import config
import unittest
from main import irods_seq_data_tests as irods_seq_tests
...
class MD5Test(unittest.TestCase):
    ...
    def test_check_bam_md5_metadata(self):
        ...
        irods_metadata = [irods_types.MetaAVU('md5', 'df8afb9196ea7080cd261e65d4ab2ef9')]
        result = irods_seq_tests.check_md5_metadata(irods_metadata, irods_fpath)
        print result
    ...
    def test_check_cram_md5_metadata(self):
        ...
        irods_metadata = [irods_types.MetaAVU('md5', 'a58d8e78d5d7a2a55136448a81c5dd90')]
        result = irods_seq_tests.check_md5_metadata(irods_metadata, irods_fpath)
...
class AdjancentMetadataChecksTests(unittest.TestCase):
    ...
    def test_check_bam_run_id(self):
        ...
        result = irods_seq_tests.check_run_id(irods_metadata, irods_fpath)
        expected = []
    ...
    def test_check_bam_lane_metadata(self):
        ...
        result = irods_seq_tests.check_lane_metadata(irods_metadata, irods_fpath)
        expected = []
        self.assertEqual(result, expected)
    ...
    def test_check_reference(self):
        ...
        desired_ref = 'hs37d5'
        result = irods_seq_tests.check_reference(irods_metadata, desired_ref)
        self.assertEqual(len(result), 1)
