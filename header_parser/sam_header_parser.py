...
class SamFileHeaderParser:
    ...
    def parse(cls, header_as_text: str):
        ...
        It returns a SAMFileHeader - containing only the RG tags.
        WARNING: not fully implemented! Populates only the RG tags.
        Parameters
        ----------
        header_as_text : str
        ...
        for line in lines:
            if line.startswith('@SQ'):
                ...
                rg_list.append(line)
        return SAMFileHeader(rg_tag=cls.RGTagParser.parse_tags(rg_list))
    ...
    class RGTagParser:
        ...
        @classmethod
        def parse_tags(cls, tags: typing.Sequence):
