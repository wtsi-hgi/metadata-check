...
class ResultMetaData(object):
    ...
    def __getstate__(self):
        return {
            '_pickled_keymap': dict(
                (key, index)
                for key, (processor, obj, index) in list(self._keymap.items())
    ...
    def __setstate__(self, state):
        ...
        self._keymap = keymap = {}
        for key, index in list(state['_pickled_keymap'].items()):
...
class BufferedColumnResultProxy(ResultProxy):
    ...
    def _init_metadata(self):
        ...
        keymap = {}
        for k, (func, obj, index) in list(metadata._keymap.items()):
