...
class iRODSRMOperations(iRODSOperations):
    ...
    def _run_irm(cls, path, options):
        ...
        try:
            ...
            raise exceptions.iRMException(error=e.error, output=e.output, cmd=e.cmd)
...
class iRODSMakeCollOperations(iRODSOperations):
    ...
    def _run_imkdir(cls, path):
        ...
        try:
            ...
            raise exceptions.iMkDirException(error=e.error, output=e.output, cmd=e.cmd)
...
class iRODSiPutOperations(iRODSOperations):
    ...
    def _run_iput(cls, src_path, dest_path, options):
        ...
        try:
            ...
            raise exceptions.iPutException(error=e.error, output=e.output, cmd=e.cmd)
...
class iRODSMetaQueryOperations(iRODSOperations):
    ...
    @classmethod
    def _run_imeta_qu(cls, avu_dict, zone=constants.IRODS_SEQ_ZONE, operator='='):
        """
...
#        cmd_args = ["imeta", "qu", "-z", zone,"-d", attribute, operator, value]
    ...
    @classmethod
    def query_by_metadata(cls, avu_dict, zone=constants.IRODS_SEQ_ZONE, operator='='):
        """
...
class iRODSiMVOperations(iRODSOperations):
    ...
    def _run_imv(cls, src_path, dest_path):
        ...
        try:
            ...
            raise exceptions.iMVException(error=e.error, output=e.output, cmd=e.cmd)
